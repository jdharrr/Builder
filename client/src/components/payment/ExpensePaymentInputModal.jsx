...
export const ExpensePaymentInputModal = ({handleSave, handleClose, expense, preSelectedDueDate = null, isSaving = false}) => {
    ...
    return (
        <Modal
            title={`${expense?.name ?? 'Expense'} Payment`}
            handleClose={handleClose}
            className="app-modal payment-input-modal"
            showSave={false}
            headerContent={(
                <>
            ...
            footerContent={(
                <>
                    ...
                    <button
                        ...
                        disabled={isSaving || invalidFutureDate || paymentExists}
