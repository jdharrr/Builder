        ...
        <>
            ...
            <div className={'border border-dark rounded-2'}>
                <ul className={'nav nav-tabs border-0'} role={'tablist'}>
                    ...
                    <li className={'nav-item'} role={'presentation'}>
                        <button className={'nav-link border-0'} data-bs-toggle={'tab'} id={'late-tab'}
                                data-bs-target={'#late'} type={'button'} role={'tab'}>
                            Late Expenses
                        </button>
                    </li>
                </ul>
                ...
                <div className={'tab-content'}>
                    <div className={'tab-pane fade show active'} role={'tabpanel'} id={'upcoming'}>
                        <UpcomingList filteredExpenses={filteredExpenses} setFilteredExpenses={setFilteredExpenses} />
                    </div>
                    <div className={'tab-pane fade'} role={'tabpanel'} id={'late'}>
