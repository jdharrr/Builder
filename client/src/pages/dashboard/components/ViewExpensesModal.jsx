...
import {invalidateExpenseCaches, invalidateTotalsCaches} from "../../../utils/queryInvalidations.js";
    ...
    return (
        <>
            <Modal
                ...
                className="view-expenses-modal app-modal"
                showSave={false}
                disableOutsideClick={viewEditExpenseModal.isShowing}
                headerContent={(
                    <>
